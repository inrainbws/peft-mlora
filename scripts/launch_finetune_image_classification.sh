...
#  "--r 32 --use_mlora --use_exp --fix_b"
  "--r 16 --use_mlora --lr_multiplier 1."
  "--r 16 --use_mlora --lr_multiplier 3."
  "--r 16 --use_mlora --lr_multiplier 10."
  "--r 16 --use_mlora --lr_multiplier 30."
  "--r 16 --use_mlora --lr_multiplier 100."
)

common_args="--base_model resnet"

for exp_args in "${exp_args_list[@]}"; do

  exp_name="mlora-resnet-$counter"
